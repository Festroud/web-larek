...
**Назначение:** Создаёт функцию-генератор события, которая при вызове будет инициировать событие с указанными данными.
**Параметры:**
...
**Возвращаемое значение:** Функция, которую можно вызвать с данными (data), чтобы инициировать событие с переданными или скомбинированными данными (контекст и данные).
---
Типы
